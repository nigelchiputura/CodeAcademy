        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="./update_user.php" method="post">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Role</label>
                        <select class="form-select update-field" id="role-update" name="role">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Full Name</label>
                        <input type="text" class="form-control update-field" value="" id="full_name-update" name="full_name" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Email</label>
                        <input type="text" class="form-control update-field" value="" id="email-update" name="email" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Phone Number</label>
                        <input type="text" class="form-control update-field" value="" id="phone-update" name="phone" required>
                    </div>
                    <button type="submit" class="btn btn-primary w-100" name="user_id" value="" id="user-update-btn">Update User</button>
                </form>
            </div>
        </div>
    </div>
