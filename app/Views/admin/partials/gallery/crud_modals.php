    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="/admin/gallery/add.php" method="post" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-success w-100">Add To Gallery</button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="/admin/gallery/update.php" method="post" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-primary w-100">Update Gallery</button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title">Gallery Image Details</h5>
                <button class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            ...
            <div class="modal-body">
                ...
                <ul class="list-group">
                    <li class="list-group-item" id="id"><strong>Gallery ID:</strong> <span></span></li>
