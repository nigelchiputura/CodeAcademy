<form id="usersForm" action="../../controllers/users/delete_user.php" method="post">
            ...
            <tbody>
                <?php foreach ($users as $user) { ?>
                    <tr data-user-id="<?= htmlspecialchars($user['user_id']); ?>">
                        <td>
                            <input type="checkbox" class="user-checkbox" name="user_ids[]" value="<?= htmlspecialchars($user['user_id']); ?>">
                        </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-danger" name="user-delete" form="usersForm">
                    Delete
                </button>
            </div>
        </div>
